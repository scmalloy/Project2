...
//	Each job needs:
	...
	public void supervisoryMechanicalEngineer() {
		System.out.println("Supervisory Mechanical Engineer"
	...
	public void networkEngineer() {
		System.out.println("Network Engineer - 1"
				+ "\nJob Field: Engineering"
				...
				+ "\n	and maintaining computer networks for an organization. They are also "
	...
	public void electricalEngineerEL() {
		System.out.println("Electrical Engineer - Entry Level"
				+ "\nJob Field: Engineering"
	...
	public void nuclearEngineerML() {
		System.out.println("Nuclear Engineer - Mid Level"
				+ "\nJob Field: Engineering"
				+ "\nCompany: Duke Energy"
				+ "\nJob ID: 4619-34"
				+ "\nLocation: "
	...
	public void automotiveSalesConsultant() {
		System.out.println("Automotive Sales Consultant"
				+ "\nJob Field: Sales"
				+ "\nCompany: CarMax"
				+ "\nJob ID: 62974-18"
				+ "\nLocation: "
	...
	public void generalSalesManager() {
		System.out.println("General Sales Manager"
				+ "\nJob Field: Sales"
				+ "\nCompany: Grainger"
				+ "\nJob ID: 46198-33"
				+ "\nLocation: "
				...
				+ "\nSalary Range: $100,000+"
				+ "\nDescription: A General Sales Manager is responsible for overseeing the sales "
	...
	public void usedTruckSalesRepresentative() {
		System.out.println("Used Truck Sales Representative"
				+ "\nJob Field: Sales"
				+ "\nCompany: Ryder"
				+ "\nJob ID: 46187-21"
				+ "\nLocation: "
	...
	public void solarSalesRepresentative() {
		System.out.println("Entry Level Solar Sales Representative"
				+ "\nJob Field: Sales"
				+ "\nCompany: SunPower"
				+ "\nJob ID: 13949-88"
				+ "\nLocation: "
	...
	public void financeDirector() {
		System.out.println("Finance Director"
				+ "\nJob Field: Finance"
				+ "\nCompany: State Farm"
				+ "\nJob ID: 13549-62"
				+ "\nLocation: "
				...
				+ "\n	operations of an organization, including accounting, budgeting, forecasting, "
	...
	public void financialAnalyst() {
		System.out.println("Financial Analyst"
				...
				+ "\n	providing insights and recommendations to help organizations make informed "
	...
	public void financialComplianceManager() {
		System.out.println("Financial Compliance Manager"
				+ "\nJob Field: Finance"
				+ "\nCompany: IRS"
				+ "\nJob ID: 67913-46"
				+ "\nLocation: "
				...
				+ "\nSalary Range: $100,000+"
				+ "\nDescription: A Financial Compliance Manager is responsible for ensuring that an "
	...
	public void depositSupportSpecialist() {
		System.out.println("Deposit Support Specialist"
				+ "\nJob Field: Finance"
				+ "\nCompany: Wells Fargo"
				+ "\nJob ID: 34684-11"
				+ "\nLocation: "
				...
				+ "\n	support to ensure accurate and timely processing of deposits. They may work "
				+ "\n	in a bank or financial institution, and their duties may include verifying "
				+ "\n	deposit amounts, resolving discrepancies, and answering customer inquiries "
				+ "\n	related to deposits."
	...
	public void computerSupportTechnician() {
		System.out.println("Computer Support Technician"
				+ "\nJob Field: Computer and Information Technology"
				+ "\nCompany: IBM"
				+ "\nJob ID: 31496-32"
				+ "\nLocation: "
				...
				+ "\n	support and assistance to computer users within an organization. They diagnose "
				+ "\n	and resolve hardware and software issues, install and configure computer systems, "
	...
	public void desktopSupportTechnician() {
		System.out.println("Desktop Support Technician"
				+ "\nJob Field: Computer and Information Technology"
				+ "\nCompany: Best Buy"
				+ "\nJob ID: 34793-37"
				+ "\nLocation: "
	...
	public void communityHealthWorker() {
		System.out.println("Community Health Worker"
	...
	public void clinicMedicalAssistant() {
		System.out.println("Clinic Medical Assistant"
				+ "\nJob Field: Healthcare"
	...
	public void physicalTherapist() {
		System.out.println("Physical Therapist"
				+ "\nJob Field: Healthcare"
	...
	public void psychiatricNursePractitioner() {
		System.out.println("Psychiatric Nurse Practitioner"
				+ "\nJob Field: Healthcare"
